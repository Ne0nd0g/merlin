...
func NewCommand() *Command {
	...
	cmd.os = os.LOCAL
	description := "Stop and exit Merlin"
	usage := "quit [-y]"
	example := "Merlin» quit\n\n" +
		"\tAre you sure you want to exit? [yes/NO]:\n" +
		"\tyes\n" +
		"\t[!]Quitting..."
	notes := "The user will be prompted for confirmation to prevent from accidentally quitting the program.\n" +
		"\tThe confirmation prompt can be skipped with quit -y"
