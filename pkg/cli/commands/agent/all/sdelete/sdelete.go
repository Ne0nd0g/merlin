...
func NewCommand() *Command {
	...
	cmd.os = os.ALL
	description := "Securely delete a file by zeroing out the data"
	// Style guide for usage https://developers.google.com/style/code-syntax
	usage := "sdelete filePath"
	example := "Merlin[agent][c1090dbc-f2f7-4d90-a241-86e0c0217786]» sdelete /tmp/deleteMe.txt\n" +
...
func (c *Command) Do(m menu.Menu, id uuid.UUID, arguments string) (response commands.Response) {
	...
	response.Message = rpc.SecureDelete(id, args[1:])
	return
}
