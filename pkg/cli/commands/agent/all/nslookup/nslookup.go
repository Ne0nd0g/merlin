...
func NewCommand() *Command {
	...
	cmd.os = os.ALL
	description := "Natively resolve a hostname or IP address"
	...
	example := "Merlin[agent][c1090dbc-f2f7-4d90-a241-86e0c0217786]» nslookup 8.8.8.8 9.9.9.9 github.com google.com\n" +
	...
	notes := "This command takes a space separated list of IP addresses or hostnames and performs a DNS query " +
		"using the host's resolver through native Golang code"
...
func (c *Command) Do(m menu.Menu, id uuid.UUID, arguments string) (response commands.Response) {
	...
	response.Message = rpc.NSLOOKUP(id, args[1:])
	return
}
