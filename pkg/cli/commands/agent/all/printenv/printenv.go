...
func NewCommand() *Command {
	...
	usage := "printenv"
	example := "Merlin[agent][c1090dbc-f2f7-4d90-a241-86e0c0217786]» printenv\n" +
	...
	notes := "This command is an alias for the 'env showall' command. Native Golang code is used to execute this command."
...
func (c *Command) Do(m menu.Menu, id uuid.UUID, arguments string) (response commands.Response) {
	...
	response.Message = rpc.ENV(id, []string{"showall"})
	return
}
