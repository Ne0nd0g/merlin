...
func NewCommand() *Command {
	...
	usage := "ipconfig"
	example := "Merlin[agent][c1090dbc-f2f7-4d90-a241-86e0c0217786]» ipconfig\n" +
		...
		"\t  DHCP          Enabled\n" +
		"\t  DHCP Server:"
	notes := "Alias for the 'ifconfig' command. This command uses Go native code and does not execute a new process.\n" +
