...
func NewCommand() *Command {
	...
	usage := "rev2self"
	example := "Merlin[agent][c1090dbc-f2f7-4d90-a241-86e0c0217786]» rev2self\n" +
...
func (c *Command) Do(m menu.Menu, id uuid.UUID, arguments string) (response commands.Response) {
	...
	return token.NewCommand().Rev2Self(id, strings.Join(append([]string{"token", "rev2self"}, args[1:]...), " "))
}
