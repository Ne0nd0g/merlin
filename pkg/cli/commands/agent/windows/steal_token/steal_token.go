...
func NewCommand() *Command {
	...
	example := "Merlin[agent][c1090dbc-f2f7-4d90-a241-86e0c0217786]» steal_token 1320\n" +
...
func (c *Command) Do(m menu.Menu, id uuid.UUID, arguments string) (response commands.Response) {
	...
	return token.NewCommand().Steal(id, strings.Join(append([]string{"token", "steal"}, args[1:]...), " "))
}
