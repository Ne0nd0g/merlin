...
func NewCommand() *Command {
	...
	cmd.os = os.WINDOWS
	description := "List all named pipes on the system"
	// Style guide for usage https://developers.google.com/style/code-syntax
	usage := "pipes"
	example := "Merlin[agent][c1090dbc-f2f7-4d90-a241-86e0c0217786]» pipes\n" +
		...
		"\t\\\\.\\pipe\\trkwks"
	notes := "This command is only available to agent running on a Windows operating system! " +
		"Native Golang code is used to enumerate the named piped"
