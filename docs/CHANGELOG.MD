...
- linux/x64/bash/credentials/MimiPenguin.json module by @ahhh
- linux/x64/bash/troll/Prank.json module by @ahhh
- windows/x64/powershell/persistence/Invoke-ADSBackdoor.json
- Merlin agent DLL
